...
public class WebOfficeController {
    ...
    static {
        fileNameMap.put("1", "C:\\weboffice\\file\\1.docx");
        fileNameMap.put("2", "C:\\weboffice\\file\\2.pptx");
        fileNameMap.put("3", "C:\\weboffice\\file\\3.xlsx");
    }
    @RequestMapping("webofficeDemo")
    public String convertDemo(){
        return "webofficeDemo";
    }

    @RequestMapping(value="/api/v1/3rd/file/info", method = RequestMethod.GET)
    @ResponseBody
    public Object fileInfo(HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException {
        System.out.println("=============fileInfo===============");
        String fileid = request.getParameter("_w_fileid");
        System.out.println("=============_w_fileid:"+fileid);
        ...
        try {
            ...
            //// TODO: 文件的id应该唯一
            file.put("id", fileid);
            file.put("name", getFileName(fileid));
            //// TODO: 文件的版本控制
            ...
            file.put("download_url", fileModel.download_url + "/sources/imgs/" + getFileName(fileid));
    ...
    @RequestMapping(value="/api/v1/3rd/file/version/{version}", method = RequestMethod.GET)
    @ResponseBody
    public Object fileVersionInfo(@PathVariable("version") Long version, @RequestParam("_w_fileid") String fileid) throws UnsupportedEncodingException {
        ...
        try {
            ...
            file.put("modifier", fileModel.modifier);
            //// TODO: 下载链接中的参数如带中文等特殊字符，参数必须进行urlencode
            file.put("download_url", fileModel.download_url + File.separator + "sources" + File.separator + getFileName(fileid));
            jsonObject.put("file", file);
            UserModel userModel = new UserModel();
            user.put("id", userModel.id);
            user.put("name", userModel.name);
    ...
    @RequestMapping(value="/api/v1/3rd/user/info", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value="/api/v1/3rd/file/online", method = RequestMethod.POST)
    @ResponseBody
    public void online() {
        System.out.println("=============online===============");
    }

    @RequestMapping(value = "/api/v1/3rd/file/save", method = RequestMethod.POST)
    @ResponseBody
    ...
    @GetMapping("/api/weboffice/getFile")
